...
public class ReporteReferidoxInteres_Excel {
	...
	public boolean generarExcel(String idcurso, String idsem, String curso, String sem) {
		...
		try {
			...
			String query = "select i.codReferido, r.nombre, r.apepat, r.apemat, r.correo from intereses_referido as i inner join referido as r on " + 
			...
			String rutaArchivo = System.getProperty("user.home") + "/Desktop/Reporte_RecomendadoxInteres_"+curso+"_"+sem+".xls";		
			...
			hoja.addMergedRegion(CellRangeAddress.valueOf("B2:E2"));
			hoja.addMergedRegion(CellRangeAddress.valueOf("B3:E3"));
			hoja.addMergedRegion(CellRangeAddress.valueOf("B4:E4"));
			
			Cell celda01 = fila.createCell(1);
			celda01.setCellStyle(titulo);
			celda01.setCellValue("FACULTAD DE INGENIERIA Y ARQUITECTURA - FIA");
			fila = hoja.createRow(2);
			Cell celda02 = fila.createCell(1);
			celda02.setCellStyle(titulo);
			celda02.setCellValue("REPORTE DE DOCENTES RECOMENDADOS POR CURSO - "+ curso);
			fila = hoja.createRow(3);
			Cell celda03 = fila.createCell(1);
