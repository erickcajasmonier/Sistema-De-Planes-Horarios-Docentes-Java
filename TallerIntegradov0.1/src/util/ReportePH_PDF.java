...
//				documento.add(imagenes);
				...
				par1.add(new Phrase("PLAN DE ESTUDIOS CON HORAS ", fontitulo));
				par1.add(new Phrase(Chunk.NEWLINE));
				par1.add(new Phrase("SEMESTRE ACADEMICO " + año + "-" + semestre, fontitulo));
				par1.setAlignment(Element.ALIGN_CENTER);
				par1.add(new Phrase(Chunk.NEWLINE));
				par1.add(new Phrase(Chunk.NEWLINE));
				par1.add(new Phrase("CICLO I ", fontitulo));
				par1.add(new Phrase(Chunk.NEWLINE));
				par1.setSpacingAfter(10f);
				documento.add(par1);
...
//					if()
//				}
				PdfPTable tabla = new PdfPTable(10);//con 4 columnas
				PdfPCell cell = new PdfPCell(new Paragraph(" "));
				tabla.setWidthPercentage(90);
				tabla.setWidths(new float[]{1f, 1.9f, 0.5f,0.3f,0.3f,0.3f,0.3f,0.3f,0.3f,0.8f});
				cell.setColspan(3);
				...
				PdfPCell cell1 = new PdfPCell(new Paragraph("HORAS SEMANALES",FontFactory.getFont("Arial",8, Font.BOLD, BaseColor.BLACK)));
				cell1.setColspan(3);
				...
				PdfPCell celda6 = new PdfPCell(new Paragraph("HL",FontFactory.getFont("Arial",8, Font.BOLD, BaseColor.BLACK)));//nombre a las columnas iniciales
				celda6.setHorizontalAlignment(Element.ALIGN_CENTER);
				/*AGREGO UNA CELDA PARA 3 COLUMNAS*/
				PdfPCell cell2 = new PdfPCell(new Paragraph("HORAS SEMESTRALES",FontFactory.getFont("Arial",8, Font.BOLD, BaseColor.BLACK)));
				cell2.setColspan(3);
				...
				PdfPCell celda9 = new PdfPCell(new Paragraph("HL",FontFactory.getFont("Arial",8, Font.BOLD, BaseColor.BLACK)));//nombre a las columnas iniciales
				...
				tabla.addCell(celda9).setHorizontalAlignment(Element.ALIGN_CENTER);
				...
				while(rs.next()){
					...
					if(fl!=bnd){
						...
						bnd++;
						String ciclo = "";
						if(bnd==1)ciclo="CICLO I";
						if(bnd==2)ciclo="CICLO II";
						if(bnd==3)ciclo="CICLO III";
						if(bnd==4)ciclo="CICLO IV";
						if(bnd==5)ciclo="CICLO V";
						if(bnd==6)ciclo="CICLO VI";
						if(bnd==7)ciclo="CICLO VII";
						if(bnd==8)ciclo="CICLO VIII";
						if(bnd==9)ciclo="CICLO IX";
						if(bnd==10)ciclo="CICLO X";
						if(bnd==11)ciclo="ELECTIVO 1";
						if(bnd==12)ciclo="ELECTIVO 2";
						if(bnd==13)ciclo="ELECTIVO 3";
						Paragraph par2 = new Paragraph();
						Font font2 = new Font(Font.FontFamily.HELVETICA, 10, Font.BOLD, BaseColor.BLACK);
						par2.add(new Phrase(ciclo, font2));
						par2.setAlignment(Element.ALIGN_CENTER);
						par2.add(new Phrase(Chunk.NEWLINE));
						par2.setSpacingAfter(10f);
						documento.add(par2);
					...
					PdfPCell nue = new PdfPCell(new Phrase(rs.getString(9), fontcuerpo));
					...
					tabla.addCell(nue).setHorizontalAlignment(Element.ALIGN_CENTER);
