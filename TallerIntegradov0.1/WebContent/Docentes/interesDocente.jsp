                        ...
                        <div class="main_service roomy-100">
                          ...
                          <div class="row">
                              ...
                              <div>
                                  ...
                                  <div class="col-md-10">
                                  <input type="text" class="form-control" id="txtnumdoc" value="<%out.print(session.getAttribute("dni"));%>"
										name="txtnumdoc"></div>
                                  <div class="col-md-2">
								...
								<%Conexion con = new Conexion();
		    	  				ResultSet rs = con.executeQuery("SELECT IDCURSO, NOMBRE FROM CURSO WHERE IDCURSO LIKE 'AD%'");
		    					%>
                                  <p>Curso Adicional</p>
                                  <div id="divAdicional">
						            <select required name="selectAdicional" id="selectAdicional" class="form-control selectAdicional">
...
function grabarInteres(){
	...
	$.ajax({
		type:'POST',
		url :'<%=request.getContextPath()%>/RegistrarInteresDocente',
		dataType:'JSON',
		data:{
...
$('#table_interes').on('click', '#btn_eliminar', function(){
	var hi= confirm("¿Esta seguro que desea eliminar?");
  	if (hi== true){
        ...
        $.ajax({
	        type: 'POST',
	        url: '/TallerIntegradov0.1/EliminarInteresDocente',
	        data: {
		        	idcurso: idcurso,
		        	numdoc:numdoc,
		        	sem:sem
...
$('body').on('click', '#btn_volver', function(){
	...
	function buscarInteres() {
		...
		$.ajax({
	        type: 'POST',
	        url: '/TallerIntegradov0.1/ListarInteresxDocente',
	        data : {
