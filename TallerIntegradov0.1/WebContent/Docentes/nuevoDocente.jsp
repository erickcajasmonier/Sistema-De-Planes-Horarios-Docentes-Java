...
<html class="no-js" lang="en">
    <head>
		...
		<script src="<%=request.getContextPath()%>/JS/Docentes/NuevoDocente.js"></script>
    ...
    <body data-spy="scroll" data-target=".navbar-collapse">
        ...
        <div class="culmn">
            ...
            <section id="ayuda" class="">
                <div class="container">
                     <form action="usuarioDocente.jsp" id="form1">
                           ...
                           <div class="col-md-8">
                            <h4>Datos Personales</h4>
                                ...
                                <div class="row">    
                                    ...
                                    <div class="col-md-4">
                                    <p>N° de Documento:</p>
                                    <input type="number" class="form-control onlyNumber" id="txtnumdoc" name="txtnumdoc"/>
                                    </div>
                            ...
                            <h4>Grados Universitarios</h4>
                                <div class="row">    
                                    ...
                                    <input type="text" id="txtmenmay" class="form-control onlytext">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p>Universidad:</p>
                                        <input type="text" class="form-control onlytext" id="txtuni">
                                    </div>   
                                </div>
                             </div>
                          </div>
		                        ...
		                        <h4>Datos Extras</h4>
		                            ...
		                            <div class="row">     
		                                ...
		                                <div id="divEscuela" class="col-md-3">
	                                  	<p>Escuela:</p>
	                                  	<select class="form-control selectEscuela" name="selectEscuela" id="selectEscuela">
											<option value="" selected disabled>--Seleccionar--</option>
							 			</select>
							 			<!--  <input type=hidden id="txtescuela" name="txtescuela" class="form-control">-->
	                                  	</div>
                        ...
                        <div class="row">
                                <div class="col-md-4"><input type="button" id="btnRegistrarDocente" class="btn btn-success form-control" value="Registrar">
                                </div>  
                                <div class="col-md-4"><input type="submit" id="btnCREAR" class="btn btn-success form-control" value="Crear Usuario" disabled>
                                </div>
                                <div class="col-md-4">
