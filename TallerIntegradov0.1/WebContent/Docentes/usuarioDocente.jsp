...
<html class="no-js" lang="en">
    ...
    <%
       String nombre, apepat, apemat, correo, dni, escuela;
       ...
       escuela= request.getParameter("selectEscuela");
    %>
                        ...
                        <div class="main_service roomy-100" style="width:80%">
                            ...
                            <div class="row">
                                <div class="col-md-4" id="divReferido1">
                                    <p>Nombre(s)</p>
                                    <input type="text" id="txtnombre" name="txtnombre"  value="<%= nombre %>" class="form-control onlytext" required >
                                </div>
                                <div class="col-md-4" id="divReferido1">
                                    <p>Apellido Paterno</p>
                                    <input type="text" id="txtapepat" name="txtapepat"  value="<%= apepat %>" class="form-control onlytext" required >
                                </div>
                                <div class="col-md-4" id="divReferido1">
                                    <p>Apellido Materno</p>
                                    <input type="text" id="txtapemat" name="txtapemat"  value="<%= apemat %>" class="form-control onlytext" required>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4" id="divReferidoDni">
                                    <p>N° de Documento</p>
                                    <input type="number" class="form-control" id="txtdni" name="txtdni"  value="<%= dni %>" onKeyPress="return SoloNumeros(event);"  minlength="8" maxlength="11" required>
                                </div>
                                <div class="col-md-4" id="divReferido1">
                                    <p>E-mail</p>
                                    <input type="email" id="txtcorreo" name="txtcorreo"   value="<%= correo %>" class="form-control" required>
                                </div>
                                <div class ="col-md-4" id="divReferido1">
                                    <p>Perfil</p>
                            ...
                            <div class="row" id="">
                                <div class ="col-md-4" id="">
                                    ...
                                    <select  class="form-control selectEsc" id="selectEscuela" name="selectEscuela" required>
										<%
										      EscuelaJDBC esc = new EscuelaJDBC();
										      List<beans.Escuela> lista = esc.listar(escuela);
										             if(lista !=null)
										              {
										            	 for(int i=0; i<lista.size(); i++)
										                 {
										            	  beans.Escuela bean = lista.get(i);
										%>
									            <option value="<%= escuela %>"> <%= bean.getDescripcion() %> </option>
								        <%
										            }
										              }
								        %>
									...
									<!-- <input type="text" id="txtesc" name="txtesc" value="<%= escuela %>" class="form-control" >  -->
                                </div>
                                <div class="col-md-4" id="divReferido1">
...
<script>
var esc = document.getElementById("txtesc");
document.getElementById("selectEscuela").setAttribute('value',esc);
</script>
<script>
      ...
      $.ajax({
        ...
        success: function(data) {
		    	 if(data == "1")
		    	 {
		    		 ...
		    		 location.href="nuevoDocente.jsp"
