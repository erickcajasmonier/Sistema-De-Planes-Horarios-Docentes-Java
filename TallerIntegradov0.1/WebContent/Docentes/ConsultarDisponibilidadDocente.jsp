            ...
            <section id="ayuda" class="" >
                <div class="container">
                        <div class="main_service roomy-100" >
                            <h4>Consulta Disponibilidad Docentes</h4>
                            <br>
							  ...
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
							      <div class="modal-header">
							        ...
							        <h4 class="modal-title" id="myModalLabel">Disponibilidad del Docente</h4>
							      </div>
...
function buscarDisponibilidad(numdoc, sem) {
	...
	$.ajax({
        type: 'POST',
        url: '/TallerIntegradov0.1/ListarDisponibilidadxDocente',
        data : {
			numdoc : numdoc,
			sem:sem
		},
...
function listarDocentes() {
	...
	$.ajax({
        type: 'POST',
        url: '/TallerIntegradov0.1/ListarDocentesRegistrados',
        data : {
		},
        success: function(data)
        {            	
			...
			if(data == "_"){
				...
				for (var i = 0; i < array.length -1; i++) {
					...
					var apepat = array[i].split("=")[1];
					var apemat = array[i].split("=")[2];
					var nombre = array[i].split("=")[3];
					var telefono = array[i].split("=")[4];
