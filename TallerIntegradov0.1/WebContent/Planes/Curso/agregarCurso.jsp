...
<form action="<%=request.getContextPath()%>/ServletCurso?action=agregarCurso"
method="post">
			...
			<div class="main_service roomy-100"><br>
						...
						<div style="text-align: left">
							...
							<div class="row">
								<div class="col-md-12" style="min-height: 60px">
									...
									<div class="col-md-8">
										<input class="form-control" type="text" name="codigoSAP" maxlength=11 oninput="this.value=this.value.replace(/[^0-9]/g,'');">
									</div>
								</div>
								<div class="col-md-12" style="min-height: 60px">
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<input class="form-control" type="text" name="nombreCurso">
									</div>
								</div>
								<div class="col-md-12" style="min-height: 60px">
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<input class="form-control" type="text" name="sicat" maxlength=6 oninput="this.value=this.value.replace(/[^0-9]/g,'');">
									</div>
								</div>
								<div class="col-md-12" style="min-height: 60px">
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<select class="form-control" name="propietarioCurso">
											<div class="dropdown-menu">
												<option class="dropdown-item">Departamento
													Académico</option>
												<option class="dropdown-item">Ingeniería de
													Computación y Sistemas</option>
												<option class="dropdown-item">Ingeniería Civil</option>
												<option class="dropdown-item">Ingeniería en
													Industrias Alimentarias</option>
												<option class="dropdown-item">Ingeniería
													Electrónica</option>
				...
				<div class="col-md-5 col-lg-5">
					<div class="col-md-12" style="min-height: 60px;">
						...
						<div class="col-md-6">
							<input class="form-control" id="creditos" type="text" readonly
								name="creditoCurso">
						</div>
					</div>
					...
					<div class="col-md-12" style="min-height: 60px;text-align:right">
						...
						<div class="col-md-6">
							<input class="form-control" type="text" id="r1" name="requisitoCurso01">
						</div>
						<div class="col-md-2">
													...
													<tbody>
														<%
															java.util.List<beans.Curso> lista = (java.util.List<beans.Curso>)request.getAttribute("lista");
																																				if(lista!=null){
																																					for(int i = 0; i<lista.size(); i++){beans.Curso bean = lista.get(i);
														%>
														<tr>
															<td
																style="width: 120px; text-align: center; color: black"><%=bean.getIdCurso()%></td>
															<td style="width: 160px; color: black"><%=bean.getNombre()%></td>
															<td><input class="btn btn-block btn-danger"
																type="button" onclick="AgRequi('<%=bean.getIdCurso()%>')"
						...
						<div class="col-md-6">
							<input class="form-control" type="text" id="r2" name="requisitoCurso02">
						</div>
						<div class="col-md-2">
							<!-- Boton que llamará al modal -->
								<button type="button" class="btn btn-primary btn-sm"
												...
												<table style="color: black;" id="myTable"
													...
													<tbody>
														...
														<tr>
															...
															<td style="width: 160px; color: black"><%=bean.getNombre()%></td>
															<td><input class="btn btn-block btn-danger"
																type="button" onclick="AgRequi2('<%=bean.getIdCurso()%>')"
																id="estado" type="button" class="" value="Agregar"></td>
															<%
																}
															%>
					...
					<div class="col-md-12" style="min-height: 60px;text-align:right">
						...
						<div class="col-md-6">
							<input class="form-control" type="text" id="r3" name="requisitoCurso03">
						</div>
						<div class="col-md-2">
							<!-- Boton que llamará al modal -->
								<button type="button" class="btn btn-primary btn-sm"
					...
					<!-- DIV ALERTAAAAAAAAAAAAAAAAAA -->
							<div>
							    <p style="text-align:center; color:red;">${message}</p>
							</div>
					 <input class="btn btn-success form-control" onclick="exito()" type="submit"
									value="Agregar Curso">	
